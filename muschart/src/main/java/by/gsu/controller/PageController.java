...
public class PageController {
    ...
    @RequestMapping(value = {SETTINGS_URI, LOGIN_URI, REGISTRATION_URI, PLAYLIST_URI,
            ARTISTS_FULL_URI, GENRES_FULL_URI, TRACKS_FULL_URI, ARTIST_FULL_URI, GENRE_FULL_URI,
            TRACK_FULL_URI, GENRE_ARTISTS_FULL_URI, TRACK_ARTISTS_FULL_URI, USER_ARTISTS_FULL_URI,
