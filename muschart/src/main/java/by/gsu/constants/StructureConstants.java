...
public abstract class StructureConstants {
    ...
    public abstract static class Tables {
        ...
        public static final String TRACK_UNIT   = "track_unit";
    ...
    private abstract static class ModelColumns {
    ...
    public abstract static class ArtistColumns {
        ...
        public static final String ID     = ModelColumns.ID;
    ...
    public abstract static class RoleColumns {
    ...
    public abstract static class UnitColumns {
