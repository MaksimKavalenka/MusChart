...
<html>
	...
	<body>
		...
		<form method="POST" name="deleteArtistTagForm" action="/web/edit">
			<input type=hidden name="action" value="DELETE_ARTIST_TAG">
			<table class="form">
				<tr>
					<td></td>
					<td>Choose the artist and its tags you want to delete</td>
				</tr>
				<tr>
					<td></td>
					<td>
