...
<html>
	<head>
		<title>Delete Track-Artist</title>
	...
	<body>
		...
		<form method="POST" name="deleteTrackArtistForm" action="/web/edit">
			<input type=hidden name="action" value="DELETE_TRACK_ARTIST">
			<table class="form">
				<tr>
					<td></td>
					<td>Choose the track and its artists you want to delete</td>
				</tr>
				<tr>
					<td></td>
					<td>
