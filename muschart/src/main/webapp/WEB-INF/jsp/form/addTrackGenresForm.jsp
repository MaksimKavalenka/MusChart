...
<html>
	...
	<body>
		...
		<form method="POST" name="addTrackTagForm" action="/web/edit">
			<input type=hidden name="action" value="TRACK_TAG">
			<table class="form">
				<tr>
					<td></td>
					<td>Choose the track and its tag</td>
				</tr>
				<tr>
					<td></td>
					<td>
